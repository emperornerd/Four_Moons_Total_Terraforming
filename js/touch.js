...
if(joystick){
  ...
  if(window.PointerEvent){
    ...
    joystick.addEventListener('pointermove',(ev)=>{
      // Guard on the captured pointer id only. Do NOT filter by pointerType
      // here: on some mobile browsers (notably iOS Safari) a captured touch
      // drag can report pointerType 'mouse', which would silently drop the
      // move and lock the direction until the next press.
